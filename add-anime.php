<!DOCTYPE html>
        ...
        <?php
            ...
            if($_POST['title'] != null){
                if ($_SERVER["REQUEST_METHOD"] == "POST"){
                    $sql = "INSERT INTO anime(title,img,date)
                        VALUES(
                        '".$_POST['title']."',
                        '".$_POST['img']."',
                        '".$_POST['date']."')";
                    ...
                    if($results === false){
                    ...
                    }else
                        {
                            ...
                            echo "Added an anime with ID: $idd"; 
                        } 
                    $dbconn->close(); 
            }
    ?>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <form action="add-anime.php" method = "POST">
                    <div>
                        <input type="text" name="title" placeholder = "Title of anime">
                    </div>
                    <div>
