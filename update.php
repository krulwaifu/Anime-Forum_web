    ...
    <body>
                ...
                <form action="Main-page.php" method="POST">
                  <button class="nav-link navbar-brand" type="submit">厨KEKISKIMIRO</button>
                    ...
                    <span class="dropdown-item">
                        ...
                        <span class="dropdown-item">
                            <a style="text-decoration: none;" href="contests.html"><p><span><i class="fas fa-trophy"></i></span> Турниры </span></a>
                        </span>
                    </div>
                    </div>
        ...
        <main>
            <div class="container">
                <form action="update.php" method = "POST">
                    <div>
                        <input type="text" name="news_id" placeholder = "Choose id of article">
                    </div>
                    <div>
                        <input type="text" name="title" placeholder = "Name of article">
                    </div>
                    <div>
                        <input type="text" name="img-url" placeholder = "Insert url of image"></input>
                    </div>
                    <div>
